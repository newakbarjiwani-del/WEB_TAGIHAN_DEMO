...
-- 3) log_qris_push  — audit trail setiap callback pushNotif (bayar / error / not found)
-- =============================================================================

-- -----------------------------------------------------------------------------
-- 1. Header generate QRIS
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS mst_qris (
  ...
  vano VARCHAR(64) NULL COMMENT 'Prefix 222222 + random (routing pushNotif)',
...
-- -----------------------------------------------------------------------------
-- 2. Detail item tagihan per QRIS
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 3. Log callback pushNotif QRIS (baru)
-- Diisi oleh islamic_center/qris/pushNotif/tagihanCicilan.php
-- -----------------------------------------------------------------------------
...
-- =============================================================================
-- Jika mst_qris / mst_qris_item sudah ada, cukup jalankan blok CREATE log_qris_push
-- di atas saja.
-- =============================================================================
